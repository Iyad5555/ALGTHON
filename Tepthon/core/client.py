                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        ftext = f"\nيتم تحميل هذا الملف فقط هنا ،\
                                  ...
                                  \n\nنحن نحترم خصوصيتك.\
                                  \n\nفقـط قـم بإعـادة توجيـه هـذه الرسـالة إلى مطـور السـورس @xx1_zww\
                                  \n\n--------بـدء تتبـع سجـل تيبثـون 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.--------\
                        ...
                        ftext += "\n\n--------نهـاية سجـل تتبـع تيبثـون 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.--------"
                        ...
                        link = "[IYAD](https://t.me/zxaax)"
                        text = (
                            "**✘ تقـريـر اشعـار تيبثـون 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. ✘**\n\n"
            ...
            async def wrapper(check):
                try:
                    ...
                    if not disable_errors:
                        ...
                        text = "**✘ تقـريـر اشعـار تيبثـون 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. ✘**\n\n "
                        link = "[IYAD](https://t.me/zxaax)"
