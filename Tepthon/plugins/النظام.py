...
async def psu(event):
    ...
    softw = "** 𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝑺𝒀𝑺𝑻𝑬𝑴 𝑰𝑵𝑭𝑶 𓆪 **\n"
...
async def cpu(event):
    ...
    await edit_or_reply(
        event, f"**[𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.](tg://Algthon1/) CPU Model:**\n{o}"
    )
...
async def _(event):
    ...
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#إعــادة_التشغيــل\n\n" "**⪼ بـوت تيبثـــون في وضـع إعــادة التشغيـل انتظـر**\n\n" "**⪼ إذا لـم يستجـب البـوت بعـد 5 دقائـق ..**\n**⪼ قـم بالذهـاب إلى حسـاب كويب**\n**⪼ وإعــادة التشغيـل اليـدوي @Koyeb_Solutions**")
    zzz1 = await edit_or_reply(event, f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**")
    await asyncio.sleep(1)
    zzz2 = await zzz1.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟷𝟶 ▬▭▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz3 = await zzz2.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟸𝟶 ▬▬▭▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz4 = await zzz3.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟹𝟶 ▬▬▬▭▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz5 = await zzz4.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟺𝟶 ▬▬▬▬▭▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz6 = await zzz5.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟻𝟶 ▬▬▬▬▬▭▭▭▭▭")
    await asyncio.sleep(1)
    zzz7 = await zzz6.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟼𝟶 ▬▬▬▬▬▬▭▭▭▭")
    await asyncio.sleep(1)
    zzz8 = await zzz7.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟽𝟶 ▬▬▬▬▬▬▬▭▭▭")
    await asyncio.sleep(1)
    zzz9 = await zzz8.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟾𝟶 ▬▬▬▬▬▬▬▬▭▭") 
    await asyncio.sleep(1)
    zzzz10 = await zzz9.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟿𝟶 ▬▬▬▬▬▬▬▬▬▭") 
    await asyncio.sleep(1)
    zzzz11 = await zzzz10.edit("ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n**•─────────────────•**\n\n**⇜ جـارِ إعـادة تشغيـل بـوت تيبثـــون . . .🌐**\n\n%𝟷𝟶𝟶 ▬▬▬▬▬▬▬▬▬▬💯") 
    sandy = await edit_or_reply(
        zzzz11,
        f"ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 🝢 **إعــادة التشغيــل**\n"
        f"**•─────────────────•**\n\n"
...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "لـ إطفـاء الداينـو الخاص بتنصيبك بهيروكـو .. لا تستطيع اعاده التشغيل مرة اخرى عبر حسابك عليك الذهاب لحساب كويب واتباع الشرح التالي https://t.me/Algthon1/1",
...
async def _(event):
    ...
    o = stdout.decode()
    OUTPUT = (
        f"**[𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.](tg://Algthon1/) - فـارات تنصيبـك هـي:**\n\n\n{o}"
    )
    if len(OUTPUT) > Config.MAX_MESSAGE_SIZE_LIMIT:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "env.text"
...
async def _(event):
    ...
    stdout, stderr = await process.communicate()
    o = stdout.decode()
    OUTPUT = f"**[ᯓ 𝗦𝗢𝗨𝗥𝗖𝗘 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.](tg://Algthon1/) - سرعـة السيرفـر**\n**- تم حسـاب سرعـة سيرفـر البـوت الخـاص بك :**\n\n{o}"
    if len(OUTPUT) > Config.MAX_MESSAGE_SIZE_LIMIT:
        with io.BytesIO(str.encode(OUTPUT)) as out_file:
            out_file.name = "env.text"
            await event.client.send_file(
...
async def zeddd(event): # Code By T.me/zzzzl1l
    uname = platform.uname()
    zedt = "**- تاريخ تنصيبـك لـ بـوت الجثون - 𓆩𝙎𝙊𝙐𝙍𝘾𝞝 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.**\n\n"
