...
ZelzalTZ_cmd = (
    ...
    "𓆩 [𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗩𝗮𝗿𝘀 - قنـاة الفـارات](t.me/Algthon1) 𓆪"
)

zed_temp = """
┏───────────────┓
│ ◉ ѕᴏụʀᴄᴇ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. ɪs ʀᴜɴɴɪɴɢ ɴᴏᴡ
┣───────────────┫
│ ● ɴᴀᴍᴇ ➪  {mention}
│ ● ᴛᴇᴘᴛʜᴏɴ ➪ {telever}
│ ● ᴘʏᴛʜᴏɴ ➪ {pyver}
...
async def _(event):
    butze = [
        [Button.inline("𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁", data="ZAZ")],
        [
            Button.inline("البـوت 🤖", data="botvr"),
            Button.inline("الحساب🎗", data="acccount"),
        ],
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر البـــوت 🦾🤖](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر البـوت المسـاعد :**\n\n",
            buttons=[
                [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المجمــوعــه 🛗](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر المجمــوعــه :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲??𝗯𝗼𝘁 - اوامــر المجمــوعــه²](t.me/Algthon) .
**- الامـر :**
**⪼** `.حذف رسائلي`
**⪼** `.مسح`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر مكـافح التكــرار 🛡](t.me/Algthon) .
**- الامـر :**
**⪼** `.ضع التكرار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المنــع 🚫](t.me/Algthon) .
**- الامـر :**
**⪼** `.منع`
**⪼** `.الغاء منع`
**⪼** `.قائمة المنع`
...
async def _(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاضـافه والتفليـش 👾](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الاضـافه والتفليـش :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الفــارات 🧬](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر الفــارات :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الوقتــي 🕰](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الوقتــي :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات المنطقـه الزمنيـة 🌐](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات المنطقـه الزمنيـة :**\n\n",
        buttons=[
...
async def _(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات حمايـة الخــاص 🛄](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات حمايـة الخــاص :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر فــارات الفحـص 🏮](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر فــارات الفحـص :**\n\n",
        buttons=[
            [
...
async def _(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه والتحشيش 🏂🎃](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر التسليـه والتحشيش :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التسليـه 🏂](t.me/Algthon) .
**⪼** `.تسليه1`
**⪼** `.تسليه2`
**⪼** `.تسليه3`
**⪼** `.تسليه4`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر التحشيش 🎃](t.me/Algthon) .
**- الامـر :**
**⪼** `.رفع تاج`
**⪼** `.رفع بقلبي`
**⪼** `.رفع مرتي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الالـعــاب 🎮🎳](t.me/Algthon) .
**- الامـر :**
**⪼** `.بلاي`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر حمـايــة الخــاص 🛡](t.me/Algthon) .
**⪼** `.الحمايه تفعيل`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - فــارات حمـايــة الخــاص 🛡](t.me/Algthon) .
**⪼** `.اضف عدد التحذيرات`
**لـ تغييـر عدد تحذيرات امـر حماية الخاص التي يقوم البوت باعطائها للشخص الذي يراسلك خاص قبل حظـره**
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر المـرفقــات 🖥](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر مرفقـات السـورس :**\n\n",
            buttons=[
                [
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الستـوريـات 🎆🏖](t.me/Algthon) .
**- الامـر :**
**⪼** `.حالات واتس`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الآفتـــارات والصــور 🎆🏖](t.me/Algthon) .
**- الامـر :**
**⪼** `.بنات`
...
async def zed_help(event):
    ...
    try:
        await event.edit(
            "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات السـورس :**\n\n",
            buttons=[
                [
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - ادوات الروابــط 💡](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر ادوات الروابــط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الادوات 💡](t.me/TepThon) .
**- الامـر :**
**⪼** `.اختصار`
**⪼** `.الغاء اختصار`
...
**- مثـال :**
`.اختصار https://github.com/user/name`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الاشتــراك الاجبــاري 🛗](t.me/Algthon) .
**- الامـر :**
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر الصيـد & التشيكـر ❇️](t.me/Algthon) .
...
async def zed_help(event):
    await event.edit(
        "[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميـع النقـاط 💡](t.me/Algthon) .\n\n**⎉╎اليك عـزيـزي شـࢪوحـات اوامـر تجميـع النقـاط :**\n\n",
        buttons=[
            [
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر تجميــع النقــاط 🛂](t.me/Algthon) .
**- الامـر :**
**⪼** `.المليار`
...
async def _(event):
    await event.edit(
        """[ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗨𝘀𝗲𝗿𝗯𝗼𝘁 - اوامــر النشــر التلقــائي 🌐](t.me/Algthon) .
**- الامـر :**
**⪼** `.تلقائي`
