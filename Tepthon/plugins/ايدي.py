...
zel_dev = (7205408861, 7205408861, 7205408861)
zelzal = (7205408861, 7205408861, 7205408861)
...
################# Dev ZilZal #################
    ZThon = f'<a href="T.me/Tepthon">ᯓ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. 𝗧𝗲𝗹𝗲𝗴𝗿𝗮𝗺 𝗗𝗮𝘁𝗮 📟</a>'
    ZThon += f"\n<b>⋆─┄─┄─┄─┄─┄─┄─⋆</b>\n\n"
...
################# Dev ZilZal #################
    if user_id in zelzal: 
        ...
        rotbat = "العضـو 𓅫"
################# Dev ZilZal #################
    ZED_TEXT = gvarstatus("CUSTOM_ALIVE_TEXT") or "•⎚• مـعلومـات المسـتخـدم مـن بـوت الجثون"  
    ZEDM = gvarstatus("CUSTOM_ALIVE_EMOJI") or "✦ " 
    ZEDF = gvarstatus("CUSTOM_ALIVE_FONT") or "⋆─┄─┄─┄─ 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. ─┄─┄─┄─⋆" 
