...
ZelzalChecler_cmd = (
    ...
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. - أوامـر الصيد والتشيكـر](t.me/Algthon) 𓆪\n\n"
...
"𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. - أنـواع اليـوزرات](t.me/Algthon) 𓆪\n\n"
        ...
        if replly and replly.text.startswith('@'): #Code Update by @zzzzl1l
            ...
            ch = await zedub(
                ...
                functions.channels.CreateChannelRequest(
                    ...
                    title="⎉ صيـد الجثون 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. ⎉",

                    about="This channel to hunt username by - @Algthon ",
