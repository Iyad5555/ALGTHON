...
@zedub.zed_cmd(
    ...
    info={
        ...
        "الوصـف": "لـ إطفـاء الداينـو الخاص بتنصيبك بهيروكـو .. لا تستطيع اعادة التشغيل مرة أخرى عبر حسابك عليك الذهاب لحساب هيروكو واتباع الشرح التالي https://t.me/𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.",
...
async def _(event):
    "لـ إطفـاء البـوت"
    if BOTLOG:
        await event.client.send_message(BOTLOG_CHATID, "#إيقـاف البــوت\n\n" "**- بـوت الجثون فـي وضــع الإيقـاف 🚫 .**")
    await edit_or_reply(event, "**✾╎جــارِ إيقـاف تشغيـل بـوت الجثون الآن 📟 ...**\n\n**✾╎شغِّـلنـي يـدويًـا لاحقًــا**\n**✾╎باتبـاع الشـرح** https://t.me/Algthon")
