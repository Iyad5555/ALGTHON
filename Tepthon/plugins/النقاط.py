...
ZelzalCoins_cmd = (
    "[ᯓ 𝗦𝗼𝘂𝗿𝗰𝗲 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣. - أوامـر تجميـع النقـاط](t.me/Algthon) 𓆪\n\n"
    ...
    "`.راتب وعد 50`\n\n\n"
    "**- ملاحظـة :**\n"
    "**⪼ سيتم إضـافـة المزيـد من البوتـات بالتحديثـات القادمـة .. إذا تريـد إضـافة بـوت محـدد راسـل مطـور السـورس @xx1_zww**"
)
