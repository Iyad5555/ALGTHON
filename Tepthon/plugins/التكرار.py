...
ZelzalSP_cmd = (
    "𓆩 [𝗦𝗼𝘂𝗿𝗰𝗲 𓏺𝙖𝙡𝙜𝙩𝙝𝙤𝙣.  - أوامر السبـام والتكـرار](t.me/Algthon) 𓆪\n\n"
    "`.كرر` + عـدد + كلمة\n"
    "**⪼ لـ تكـرار كلمـة معينـة لعـدد معيـن من المـرات**\n\n"
    "`.تلقائي` + الوقت بالثواني + العدد + النص\n"
    "**⪼ لـ تكـرار نص لوقت معين وعدد معين من المـرات**\n"
    "**⪼ الامر يفيد جماعة الإعلانات ومجموعات الشراء**\n\n"
    "`.تكرار ملصق`\n"
    "**⪼ لـ تكـرار ملصقـات من حزمـة معينة**\n\n"
    "`.سبام` + كلمـة\n"
    "**⪼ لـ تكـرار كلمـة أو جملـة نصية**\n\n"
    "`.وسبام` + كلمـة\n"
